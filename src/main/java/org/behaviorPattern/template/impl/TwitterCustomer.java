...
public class TwitterCustomer extends AbstractCustomer {

    public TwitterCustomer(final String uId, final String uPwd) {
        super(uId, uPwd);
    }

    @Override
    protected Boolean login(final String uid, final String uPwd) {
        log.info("Twitter customer log with uid {}, uPwd {}", uid, uPwd);
    ...
    protected String createIdentifier() {
        return String.valueOf(rnd.nextInt(40000) + 1000);
    }
}
